...
public class PuzzleHelpLayer extends CCColorLayer {
	...
	{ 
		GidiGamesActivity.nextscene= "PuzzleMenuLayer" ;
		 GidiGamesActivity.currentscene = "PuzzleHelpLayer" ;
		CCScene scene = CCScene.node();
		CCLayer layer = new PuzzleHelpLayer();
	...
	protected PuzzleHelpLayer()
	{
		...
		// Add Title
		CCBitmapFontAtlas selectgame = CCBitmapFontAtlas.bitmapFontAtlas ("HOW TO PLAY PUZZLEMANIA!", "dalek.fnt");
		...
		String helptext = "1.) Select a difficulty level and Click Start \n" +
						  "2.) Tap OR drag each tile to move it \n"	 +
						  "3.) Rearrange the tiles in increasing numeric order  \n     left to right (e.g 1 - 8) \n"	+
						"4.) Win by arranging all numbers correctly!! \n" +
