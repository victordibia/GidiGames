...
public class TicTacHelpLayer extends CCColorLayer {
	...
	public static CCScene scene()
	{
		...
		CCLayer layer = new TicTacHelpLayer();
	...
	protected TicTacHelpLayer()
	{
		...
		// Add Title
		CCBitmapFontAtlas selectgame = CCBitmapFontAtlas.bitmapFontAtlas ("HOW TO PLAY TICTACTOE!", "dalek.fnt");
		...
		String helptext = "1.) YOU DONT NEED THIS HELP :) \n" +
